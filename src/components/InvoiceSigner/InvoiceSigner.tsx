...
const InvoiceSigner = () => {
  ...
  const loadSignatures = async () => {
    try {
      ...
      if (fetchedSignatures.length > 0 && !selectedSignature) {
        ...
        console.log("Setting first signature URL:", firstSignatureUrl);
  ...
  // Debug logging
  console.log("InvoiceSigner render - selectedInvoice:", selectedInvoice);
  console.log("InvoiceSigner render - selectedSignature:", selectedSignature);
  console.log("InvoiceSigner render - signatures:", signatures);
                ...
                >
                  ...
                  >
                    <img
                      ...
                      onLoad={() => {
                        console.log("Successfully loaded signature image:", getSignatureDataUrl(sig));
                      }}
                    />
                  </div>
                  <div
